    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      >
        <img
          src={
            hovered
              ? "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=256" // Alternative closeup view
              : "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=256" // Default portrait view
          }
